        ...
        (async function() {
          try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
              ...
              body: JSON.stringify({
                websiteId: '08ee0da5-fa75-47b8-a249-2577c7177769',
                name: formData.name,
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "THE ROAD TRADER (הסוחר בדרכים) משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
